export default class selection extends Phaser.Scene {
  constructor(scene) {
    ...
    this.load.tilemapTiledJSON("map", "src/map.json"); 
  ...
  create() {
    ...
    this.player = this.physics.add.sprite(200, 750, "img_perso");
    ...
    this.plateforme_mobile = this.physics.add.sprite(2900, 750, "img_plateforme_mobile"); 
    ...
    this.levier = this.physics.add.staticSprite(2700, 770, "img_levier");

    this.physics.add.overlap(this.player, this.levier, () => {
      this.isNearLevier = true;
    }, null, this);

    this.toggleLevierKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.O);
  ...
  update() {
    ...
    if (this.isNearLevier && Phaser.Input.Keyboard.JustDown(this.toggleLevierKey)) {
        if (this.levier.active) {
